 ...
 * @param {*} input
 * @returns {boolean}
 *    True - if input is an array and every item is an object, array or class instance; or
 *    False - otherwise
 */
function isArrayOfObjects(input) {
  return Array.isArray(input) && input.every(item => item != null && typeof item === 'object')
}
